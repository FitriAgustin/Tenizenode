...
if ($_SERVER['REQUEST_METHOD'] == 'POST') { 
    ...
    if (!isset($_POST['idproduk'], $_POST['jumlahbeli'], $_POST['total'], 
$_POST['bayar'], $_POST['kembalian'])) { 
    ...
    $tanggaltransaksi = !empty($_POST['tanggaltransaksi']) ? 
$_POST['tanggaltransaksi'] : date("Y-m-d H:i:s"); 
